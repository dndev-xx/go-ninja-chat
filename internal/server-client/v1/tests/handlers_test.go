...
import (
	...
	clientv1 "github.com/dndev-xx/go-ninja-chat/internal/server-client/v1"
	clientv1mocks "github.com/dndev-xx/go-ninja-chat/internal/server-client/v1/mocks"
...
type HandlersSuite struct {
	...
	sendMsgUseCase	  *clientv1mocks.MocksendMsgUseCase
...
func (s *HandlersSuite) SetupTest() {
    ...
    s.sendMsgUseCase = clientv1mocks.NewMocksendMsgUseCase(s.ctrl)
    ...
    token := &jwt.Token{
        Claims: &middlewares.Claims{
            StandardClaims: &jwt.StandardClaims{
                Subject: s.clientID.String(),
            },
            ResourceAccess: map[string]struct {
                Roles []string `json:"roles"`
            }{
                "chat-ui-client": {
                    Roles: []string{"support-chat-client"},
                },
            },
        },
    }
