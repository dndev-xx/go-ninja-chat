...
func (rq *RequestQuery) FirstID(ctx context.Context) (id types.RequestID, err error) {
...
func (rq *RequestQuery) FirstIDX(ctx context.Context) types.RequestID {
...
func (rq *RequestQuery) OnlyID(ctx context.Context) (id types.RequestID, err error) {
	var ids []types.RequestID
...
func (rq *RequestQuery) OnlyIDX(ctx context.Context) types.RequestID {
...
func (rq *RequestQuery) IDs(ctx context.Context) (ids []types.RequestID, err error) {
...
func (rq *RequestQuery) IDsX(ctx context.Context) []types.RequestID {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
