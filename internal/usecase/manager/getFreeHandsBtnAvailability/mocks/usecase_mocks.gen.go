...
func (mr *MockmanagerLoadServiceMockRecorder) CanManagerTakeProblem(ctx, managerID any) *gomock.Call {
...
func (mr *MockmanagerPoolMockRecorder) Contains(ctx, managerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
