...
func (m *MockmessagesRepository) CreateClientVisible(ctx context.Context, reqID types.RequestID, problemID types.ProblemID, chatID types.ChatID, authorID types.UserID, msgBody string) (*messages.Message, error) {
	m.ctrl.T.Helper()
...
func (m *MockmessagesRepository) GetMessageByRequestID(ctx context.Context, reqID types.RequestID) (*messages.Message, error) {
	m.ctrl.T.Helper()
